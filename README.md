...
| مشاركة الشاشة من حاسوب/جوال | ✅ (عبر Miracast/Cast) | ✅ (عبر WebRTC) | يعمل من Chrome/Edge على ويندوز وماك ولينكس وأندرويد |
| Google Cast | ✅ | ❌ | يتطلّب ترخيص Google — انظر القسم ٣ |
...
1. **استقبال Google Cast**
   بروتوكول المستقبِل مغلق ويتطلّب اعتماداً وترخيص «Chromecast built-in» من Google،
   ولا يمكن تنفيذه في تطبيق مستقل. **البديل المتاح في التطبيق:** DLNA يغطي معظم
   حالات الاستخدام نفسها من أندرويد وويندوز.
...
المستقبِل بلا متصفّح. الملفّان يُترجمان لكنهما **غير موصولين بعد** بأي واجهة — الطرف
المرسِل وخدمة الاستقبال لم يُكتبا. لا يؤثّران على أي ميزة تعمل حالياً.
